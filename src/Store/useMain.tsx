    ...
    (set) => ({
        ...
        list: [
            ...
            },
            {
                ...
                carSeats: [
                    { title: 'Regular', quantity: 0, },
                    { title: 'Babi seats', quantity: 0, },
                    { title: 'Booster', quantity: 0, },
                    { title: 'Regular stroller', quantity: 0, },
                    { title: 'Umbrella stroller', quantity: 0, },
                    { title: 'Double stroller', quantity: 0, },
                    { title: 'Wheelchair', quantity: 0, },
                ],
                pets: [
                    { title: 'Dog', cage: false, quantity: 0, },
                    { title: 'Cat', cage: false, quantity: 0 },
