                    ...
                    return index === 8
                        ? <span
                            ...
                            onClick={() => {
                                ...
                                <div className={tabIndex+  ' text-[24px]   w-[26px] h-[26px] pt-[1px] pl-[1px]'}>9</div>
                        ...
                        : <span
                            ...
                            <div className={index===0? tabIndex+ ' text-[24px]   w-[26px] h-[26px] pt-[1px] pl-[1px]': tabIndex + ' text-[18px] w-[24px] h-[24px] pt-[2px] '}>{index+1}</div>
                            <span className={footerTabText}>{isFrench ? store.menuTabsF[index] : store.menuTabs[index]}</span>
                        </span>
                    }
                    )
...
const tabIndex = 'absolute flex font-bold -top-1 font bold flex items-center justify-center bg-white rounded-full shadow border xs:left-3 -left-2'
