...
const Alert = (): React.ReactNode => {
    const { alert, setAlert,isFrench } = useMain()
...
const modal = ' items-center justify-center pt-4 pb-4 w-4/5  max-w-[400px] shadow-2xl flex flex-col text-xl bg-white px-4 py-2  z-40 flex  font-bold rounded-xl '