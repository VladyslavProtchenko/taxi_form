import {  useLocation2 } from "../../../Store/useLocation2";
import { useReturnLocation2 } from "../../../Store/useReturnLocation2";
...
const BackWrapper = () =>{
    const { user } = useLocation2()
    const { returnTrip, setFrom, setTo,setIcon, setIcon2, setStops, setDate,setTime,setDeparture,setDeparture2,setFlight,setFlight2,setAirlines,setAirlinesBack,resetReturn, setIsReturnTrip} = useReturnLocation2()
...
const Car2 = () => {
    ...
    return (
        <div className='relative'>
            <div className='absolute top-11 left-12 text-sm text-gray-300'>Taxi Second</div>
