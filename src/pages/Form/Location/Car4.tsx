import { useLocation4 } from "../../../Store/useLocation4";
import { useReturnLocation4 } from "../../../Store/useReturnLocation4";
...
const BackWrapper = () =>{
    const { returnTrip, setFrom, setTo,setIcon, setIcon2, setStops, setDate,setTime,setDeparture,setDeparture2,setFlight,setFlight2,setAirlines,setAirlinesBack,resetReturn, setIsReturnTrip} = useReturnLocation4()
    const { user } = useLocation4()
    return <ReturnTrip 
                mainUser={user}
...
const Car4 = () => {
    ...
    const { returnTrip,setIsReturnTrip } = useReturnLocation4()

    return (
        <div className='relative'>
            <div className='absolute left-12 top-11  text-sm text-gray-300'>Taxi Fourth</div>
            ...
            <div className='flex'>
                <div className={!returnTrip.isReturnTrip ? 'flex w-full  ' : 'hidden w-full '} >
                    <TripWrapper />
                </div>
