...
const tab = ' text-center py-1 duration-300 rounded px-3 font-bold'
const returnTabActiveOne = 'max-w-[120px] mx-5 items-center  z-10  text-white rounded flex cursor-pointer ' 
