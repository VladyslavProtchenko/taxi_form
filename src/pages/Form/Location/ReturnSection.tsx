...
const ReturnSection = ():React.ReactNode => {
    ...
    return (
        <section className={section}>
            <div className={list[activeCarId-1].isReturnTrip ? 'hidden':'absolute top-[86px] left-0 right-0 h-[600px] z-20 bg-white opacity-50'}></div>
...
const tab = ' text-center duration-300 rounded px-3 w-full font-bold text-lg'
