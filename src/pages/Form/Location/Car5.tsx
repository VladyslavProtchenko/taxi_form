import { useLocation5 } from "../../../Store/useLocation5";
import { useReturnLocation5 } from "../../../Store/useReturnLocation5";
...
const BackWrapper = () =>{
    const { returnTrip, setFrom, setTo,setIcon, setIcon2, setStops, setDate,setTime,setDeparture,setDeparture2,setFlight,setFlight2,setAirlines,setAirlinesBack,resetReturn, setIsReturnTrip} = useReturnLocation5()
    const { user } = useLocation5()
    return <ReturnTrip 
                mainUser={user}
...
const Car5 = () => {
    ...
    const { returnTrip,setIsReturnTrip } = useReturnLocation5()

    return (
        <div className='relative'>
            <div className='absolute left-12 top-11 text-sm text-gray-300'>Taxi Five</div>
