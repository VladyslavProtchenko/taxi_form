...
const BackWrapper = () =>{
    ...
    const { returnTrip, setFrom, setTo,setIcon, setIcon2, setStops, setDate,setTime,setDeparture,setDeparture2,setFlight,setFlight2,setAirlines,setAirlinesBack,resetReturn, setIsReturnTrip} = useReturnLocation()
...
const Car1 = () => {
    ...
    return (
        <div className='relative'>
            ...
            <div className='flex'>
                <div className={!returnTrip.isReturnTrip ? 'flex w-full  flex-coll ' : 'hidden w-full '} >
                    <TripWrapper />
                ...
                <div className={returnTrip.isReturnTrip ? 'flex w-full flex-col' : 'hidden w-full '} >
                    <BackWrapper />
                </div>
            </div>
        </div>
...
// const returnContainer = ' text-sm items-center  justify-center mx-2 flex-row hidden'
// const button = ' bg-white my-2 font-bold cursor-pointer w-min justify-center rotate-90 rounded-full text-red-500 hover:text-red-400 p-1 shadow-xl  border sm:mx-2'
